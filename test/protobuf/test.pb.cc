...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendListsRequest_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_GetFriendListsRequest_test_2eproto}, {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListsResponse_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsscc_info_GetFriendListsResponse_test_2eproto}, {
...
void ResultCode::SerializeWithCachedSizes(
  ...
  // uint32 errcode = 1;
  if (this->errcode() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32(1, this->errcode(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* ResultCode::InternalSerializeWithCachedSizesToArray(
  ...
  // uint32 errcode = 1;
  if (this->errcode() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(1, this->errcode(), target);
  }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_name(), ptr, ctx, "fixbug.LoginRequest.name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // bytes pwd = 2;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsResponse::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
